    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/group1");
               ...
               // settings.put(Environment.HBM2DDL_AUTO, "update");
                ...
                //configuration.addAnnotatedClass(PhoneCodes.class);
                //configuration.addAnnotatedClass(PhoneNumbers.class);
